import{p as B}from"./chunk-K2ZEYYM2-BQLAYyoj.js";import{p as U}from"./gitGraph-YCYPL57B-5MQDGNWY-BEg4RdNn.js";import{G as q,p as H,q as V,s as Z,g as j,d as J,c as K,_ as i,l as C,x as Q,e as X,H as Y,a8 as tt,aa as et,ab as z,ac as at,m as rt,ad as it}from"./md-DMyt4e_o.js";import"./chunk-TGZYFRKZ-5YP-joq9.js";import"../index-DDPFxAiT.js";import"../modules/vue-CEQSbvvB.js";import"../modules/shiki-Bn_wYjA5.js";import"./CodeBlockWrapper.vue_vue_type_script_setup_true_lang-C9DkBQRN.js";import"../modules/unplugin-icons-CXBaq_Ik.js";import"./context-By2PPIM6.js";import"./ShikiMagicMove.vue_vue_type_style_index_0_lang-BOZuNHXn.js";import"../modules/file-saver-C8BEGaqa.js";import"./VClick-Ba_Ol-nz.js";import"./default-D1uMiU3k.js";var G=q.pie,D={sections:new Map,showData:!1,config:G},f=D.sections,w=D.showData,st=structuredClone(G),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{f=new Map,w=D.showData,Q()},"clear"),lt=i(({label:t,value:a})=>{f.has(t)||(f.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>f,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),F={getConfig:ot,clear:nt,setDiagramTitle:H,getDiagramTitle:V,setAccTitle:Z,getAccTitle:j,setAccDescription:J,getAccDescription:K,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,F)},"parse")},mt=i(t=>`
  .pieCircle{
