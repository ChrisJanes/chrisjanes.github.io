import{p as B}from"./chunk-K2ZEYYM2-DewR5AdW.js";import{p as U}from"./gitGraph-YCYPL57B-5MQDGNWY-CCrggKlQ.js";import{G as q,p as H,q as V,s as Z,g as j,d as J,c as K,_ as i,l as C,x as Q,e as X,H as Y,a8 as tt,aa as et,ab as z,ac as at,m as rt,ad as it}from"./md-C--J0IGu.js";import"./chunk-TGZYFRKZ-CYZ5YJtx.js";import"../index-CpTd1MoR.js";import"../modules/vue-NONPKcAw.js";import"../modules/shiki-4O1MQmo4.js";import"./CodeBlockWrapper.vue_vue_type_script_setup_true_lang-7_mDltR_.js";import"../modules/unplugin-icons-BymZu8he.js";import"./context-BpC5xGJM.js";import"./VClick-DlKIX6Zg.js";import"../modules/file-saver-C8BEGaqa.js";import"./VClicks-BrTRfa5C.js";import"./default-BsuL06Wz.js";var G=q.pie,D={sections:new Map,showData:!1,config:G},f=D.sections,w=D.showData,st=structuredClone(G),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{f=new Map,w=D.showData,Q()},"clear"),lt=i(({label:t,value:a})=>{f.has(t)||(f.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>f,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),F={getConfig:ot,clear:nt,setDiagramTitle:H,getDiagramTitle:V,setAccTitle:Z,getAccTitle:j,setAccDescription:J,getAccDescription:K,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,F)},"parse")},mt=i(t=>`
  .pieCircle{
